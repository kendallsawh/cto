...
<div class="container mt-4">
    <h2>Add Step to: {{ $flow->name }}</h2>

    <form method="POST" action="{{ route('process_builder.steps.store', $flow) }}">
        @csrf
        ...
        <a href="{{ route('process_builder.edit', $flow) }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
