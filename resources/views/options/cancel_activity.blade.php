	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="activitySurpressModalLabel">Cancelled/Suppress Action!</h5>
			...
			<div class="modal-body">
				...
				<form class="" method="POST" action="{{ route('activities.surpressactivity') }}" enctype="multipart/form-data">
					...
					<button type="submit" class="btn btn-danger">Continue to Suppress Request</button>
