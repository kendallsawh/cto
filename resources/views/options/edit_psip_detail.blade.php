		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="" method="POST" action="{{ route('psip.editpsipdetails', $psip->id) }}" enctype="multipart/form-data">
                    ...
                    <textarea class="form-control" name="psip_detail" id="psip_detail" rows="4">{{!is_null($psip->psipDetailForCurrentYear)? $psip->psipDetailForCurrentYear->details:''}}</textarea>
