...
<div class="container mt-4">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title text-center">Document Ogranization Page</h3>
            <h6 class="card-subtitle mb-2 text-muted">Use this option to reorganize which folders the uploaded documents belong to. Documents that are not in a folder will be placed on the left side under 'Uncategorized Documents'. You can move the documents from this section into any of the listed folders on the right side. Also you can move the documents that are shown in any of the folders into any of the other folders.</h6>
            <hr>
            <div class="row">
                <div class="col-md-6">
                    <h4>Uncategorized Documents(Drag from here)</h4>
                ...
                <div class="col-md-6">
                    <h4>Available Folders/Groups (Drop documents here)</h4>
