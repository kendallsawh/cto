    ...
    <div class="container py-5">
        ...
        <form method="post" action="{{ route('individual.register') }}" class="mx-auto shadow-lg bg-white p-4 p-md-5" style="max-width: 720px; border-radius: 12px;">
            ...
            <div class="text-center mb-4">
                ...
                <h1 class="h3 fw-normal mb-1">Individual Registration</h1>
                <p class="text-muted mb-0">Create your individual account to get started.</p>
            </div>

            <div class="row g-3">
                <div class="col-12">
                    <h2 class="h5 text-primary border-bottom pb-2">Personal Information</h2>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="passport" name="passport" value="{{ old('passport') }}" placeholder="Enter your Passport number">
                    @error('passport')
                        <span class="text-danger small">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-12 pt-3">
                    <h2 class="h5 text-primary border-bottom pb-2">TT-Biz &amp; Address</h2>
                </div>
                <div class="col-12">
                ...
                <div class="col-12 col-md-6">
                    <label for="contact_business" class="form-label">Primary Phone</label>
                ...
                <div class="col-12 col-md-6">
                    <label for="contact_mobile" class="form-label">Secondary Phone</label>
