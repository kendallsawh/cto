...
class Activity extends Model
{
    ...
    protected $fillable = ['psip_name_id','activity_name','financial_year','allocation','status_id','cancelled_by','deleted_by','activity_order','updated_by','folder_name'];
...
{
    return $this->morphOne(\App\Models\ProcessInstance::class, 'model');
}
