...
class StoreConcessionApplicationRequest extends FormRequest
{
    ...
    {
        return [
            'applicant_type' => ['required', Rule::in(['App\\Models\\Company', 'App\\Models\\Individual'])],
            'applicant_id' => ['required', 'integer', $this->applicantExistsRule()],
    ...
    {
        return Rule::exists($this->input('applicant_type') === 'App\\Models\\Company' ? 'companies' : 'individuals', 'id');
    }
}
